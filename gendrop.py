...
BANNER =  \
"""
 .d8888b.  888               888 888 8888888b.  888      888
d88P  Y88b 888               888 888 888  "Y88b 888      888
...
Y88b  d88P 888  888 Y8b.     888 888 888  .d88P 888      888
 "Y8888P"  888  888  "Y8888  888 888 8888888P"  88888888 88888888
...
def invoke_compiler(src_file, dst_file, compiler, compiler_options):
    ...
    res = os.system("'{}' '{}' -o '{}' -shared {}".format(compiler, src_file, dst_file, compiler_options))
    if res == 0:
...
def main():
    ...
    exe_file = "{}".format(args.output_file)
